#ifndef CLOUD_CONTROLLER_COMMAND_GLOBAL_VERSION_COMMAND_H
#define CLOUD_CONTROLLER_COMMAND_GLOBAL_VERSION_COMMAND_H
...
#endif // CLOUD_CONTROLLER_COMMAND_GLOBAL_VERSION_COMMAND_H
